 ...
 * The snapshot captures throughput counts, latency statistics and the queue depth at the time
 * the window closed so sinks can publish a consistent picture of consumer health.
 */
@Builder
