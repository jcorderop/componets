...
@Slf4j
@Service
@ConditionalOnProperty(prefix = "marketdata.stats.sink.prometheus", name = "enabled", havingValue = "true")
public class PrometheusStatsSinkService implements IStatsSink {
    ...
    public PrometheusStatsSinkService(
            @Value("${marketdata.stats.sink.prometheus.metric-prefix:marketdata}") String metricPrefix,
